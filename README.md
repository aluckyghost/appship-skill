...
本地检查无需账号、无需 Key。临时验证（Preview）免费：新用户可直接体验 **2 次免费临时验证**，无需注册、无需领 Key——在对话里让 AI 帮你预览，或命令行加 `--auto-key`，AppShip 会自动启用内置的免费体验额度。每次生成的临时验证环境有效 **24 小时**，到期自动销毁。
